            ...
            <article>
            	...
            	<table>
            		<tr>
            			...
            			<input type="hidden" value="${schedule.scheduleNo}" name="scheduleNo">
            			<td><input type="text" class="txtBox" name="registerName" id="registerName"></td>
            		...
            		<tr>
            			...
            			<td>
							...
							<input type="text" class="userPhNum" name="registerPhone" id="registerPhone2" minlength="4" maxlength="4"  size="16"> -
							<input type="text" class="userPhNum" name="registerPhone" id="registerPhone3" minlength="4" maxlength="4"   size="16">
            			</td>
            		</tr>
            		<tr>
            			<td class="td_wid">이메일</td>
            			<td>
            				<input type="text" name="registerEmail" id="userEmail_Id"> @
							<input type="text" name="registerEmail" id="userEmail_Domain">            			
            			</td>
            		</tr>
            	</table>
            ...
            <article>
            	<table>
            		<tr>
            			...
            			<td><input type="text" class="txtBox" name="registerCompany" id="registerCompany"></td>
            		</tr>
            		<tr>
            			<td>부서명</td>
            			<td>
							<input type="text" class="txtBox" name="registerDepartment" id="registerDepartment">
            			</td>
            		</tr>
            		<tr>
            			<td class="td_wid">직급</td>
            			<td>
            				<input type="text" class="txtBox" name="registerRank" id="registerRank">       			
            			</td>
            		</tr>
            	</table>              
            </article>
            ...
            <article>
            	<table>
            		...
            		<tr>
            			<td>교육관련문의사항</td>
            			<td>
							<textarea style="width:97%;" name="registerQuestions"></textarea>
            			</td>
            		</tr>
            	</table>
            	<div class="btn">
...
<script type="text/javascript">
	...
	$j(document).ready(function(){
		...
		$j("#next").on("click",function(){
			...
			if((${schedule.perApply} >= ${schedule.perLimit})){
				alert("신청인원이 초과되었습니다. 다른 교육을 선택해주세요.")
				return false;
			}
